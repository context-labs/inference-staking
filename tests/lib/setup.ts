...
const TEST_TOKEN_MINT_KEYPAIR = Keypair.fromSecretKey(
  new Uint8Array([
    252, 213, 179, 64, 163, 14, 134, 162, 53, 134, 118, 243, 217, 247, 143, 137,
    79, 100, 183, 144, 3, 123, 151, 66, 239, 203, 223, 52, 94, 75, 181, 112, 11,
    69, 85, 155, 92, 210, 45, 13, 91, 178, 83, 103, 5, 92, 32, 13, 82, 245, 56,
    93, 30, 173, 184, 26, 62, 31, 217, 162, 4, 28, 188, 246,
  ])
);
